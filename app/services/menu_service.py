...
class MenuService:
    ...
    def read_menu(self, menu_id: int | str):
        return self.menu_repository.read_menu(menu_id)

    def update_menu(self, menu_id: int | str, menu_data):
        return self.menu_repository.update_menu(menu_id, menu_data)

    def del_menu(self, menu_id: int | str):
        return self.menu_repository.del_menu(menu_id)

    def orm_read_menu(self, menu_id: int | str):
