...
class SubmenuService:
    ...
    async def read_submenus(self, menu_id: int | str):
        ...
        await self.cache_client.set(f'all:{menu_id}', data)
        return data
    ...
    async def create_submenu(self, submenu: SubMenuBase, menu_id: int | str):
        ...
        await self.cache_client.set(f'{menu_id}:{data.id}', data)
    ...
    async def read_submenu(self, submenu_id: int | str, menu_id: int | str):
        ...
        await self.cache_client.set(f'{menu_id}:{submenu_id}', data)
        return data
    ...
    async def del_submenu(self, submenu_id: int | str, menu_id: int | str):
        ...
        await self.cache_client.delete(f'{menu_id}:{submenu_id}')
        await self.cache_client.clear_after_change(menu_id)
        return data
