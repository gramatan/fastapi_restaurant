...
from app.schemas.dish import DishCreate, SchemasDish, DishUpdate
import logging
...
def create_dish(db: Session, dish: DishCreate):
    ...
    return SchemasDish(**db_dish_dict)
...
def read_dish(db: Session, dish_id: int):
    ...
    return SchemasDish(**dish_dict)

def update_dish(db: Session, dish_id: int, dish: DishUpdate) -> SchemasDish:
