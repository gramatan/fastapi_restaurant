...
class MenuRepository:
    ...
    async def read_menu(self, menu_id: int) -> MenuResponse:
        menu_id = int(menu_id)
    ...
    async def update_menu(self, menu_id: int, menu: MenuBase) -> MenuResponse:
        menu_id = int(menu_id)
        db_menu = await validate_menu_submenu_dish(self.db, menu_id)
    ...
    async def del_menu(self, menu_id: int) -> dict:
        menu_id = int(menu_id)
    ...
    async def orm_read_menu(self, menu_id: int):
        menu_id = int(menu_id)
        await validate_menu_submenu_dish(self.db, menu_id)
